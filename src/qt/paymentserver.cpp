...
const QString BITCOIN_IPC_PREFIX("Gaeacoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Gaeacoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Gaeacoin: click-to-pay handler");
    else
...
{
    // clicking on Gaeacoin: URLs creates FileOpen events on the Mac:
